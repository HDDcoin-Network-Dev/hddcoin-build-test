...
if __name__ == "__main__":
    update_version(f"{os.path.dirname(__file__)}/hddcoin-blockchain-gui/package.json")
    update_version(f"{os.path.dirname(__file__)}/hddcoin-blockchain-gui/packages/gui/package.json")
